---
layout: post
title: Blog back end automation-ish
image: assets/post_assets/2025-09-26_Blog_back_end_automation-ish/project_decay_line.png
---
...
<figure class="centered-figure">
  ...
  <figcaption>
    <em>Half-life decay in hours of various personal projects of mine. R code <a href="/assets/post_assets/2025-09-26_Blog_back_end_automation-ish/2025-09-26.Rmd">here</a></em>
  </figcaption>
</figure>
...
# Update archive table in Post/README.md
sed -i "6 i |[${post_title}](${title_string}) | ${todays_date} |" Posts/README.md
...
<figure class="centered-figure">
  <img src="{{ '/assets/post_assets/2025-09-26_Blog_back_end_automation-ish/2025-09-26_GH.png' | relative_url }}"
...
Data and project half-life figure generated using R v4.4.2 (7), RStudio v2024.12.1 (8), rstudioapi v0.17.1 (9), tidyverse v2.0.0 (10) and colorspace v2.1-1 (11). All figures and code in the Vector images drawn in Inkscape v1.3.2 (6). All figures and code in [assets](/assets/post_assets/2025-09-26_Blog_back_end_automation-ish). directory.
